...
so create a new folder now with name Day 77 and in this add Day 76 project as from where to where you have moved some tracking idea will be there so now from 
  Day 77 open the project okay and start doing coding 
